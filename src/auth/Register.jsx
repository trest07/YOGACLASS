  ...
  return (
    <div className="min-h-[80vh] grid place-items-center">
      <div className="w-full max-w-md bg-white border border-gray-200 rounded-2xl p-6 shadow">
        <h1 className="text-2xl font-bold text-leaf mb-1">Create your account</h1>
        ...
        {done ? (
          <div className="text-sm text-gray-700">
            ...
            <div className="mt-4">
              <Link to="/auth/login" className="text-leaf hover:underline">Go to Login</Link>
            </div>
          </div>
        ) : (
        ...
        <div className="mt-4 text-sm">
          ...
          <Link to="/auth/login" className="text-leaf hover:underline">Sign in</Link>
        </div>
      </div>
    </div>
  )
